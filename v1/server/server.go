...
type Server struct {
	...
	// The handler chain below authentication, and the wrapper Handler points at
	// so Reconfigure can replace the chain above it without invalidating the
	// handler callers were given.
