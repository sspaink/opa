...
var g = &grammar{
	rules: []*rule{
		...
		{
			name: "Sign",
			pos:  position{line: 9, col: 1, offset: 138},
			expr: &actionExpr{
				pos: position{line: 9, col: 9, offset: 146},
		...
		{
			name: "Segment",
			pos:  position{line: 13, col: 1, offset: 184},
			expr: &actionExpr{
				pos: position{line: 13, col: 12, offset: 195},
				...
				expr: &seqExpr{
					...
					exprs: []any{
						&labeledExpr{
							...
							label: "digits",
							expr: &ruleRefExpr{
								pos:  position{line: 13, col: 19, offset: 202},
								name: "Digits",
							},
						},
						&labeledExpr{
							pos:   position{line: 13, col: 26, offset: 209},
							label: "unit",
							expr: &ruleRefExpr{
								pos:  position{line: 13, col: 31, offset: 214},
								name: "Unit",
							},
						},
					},
		...
		{
			name: "Digits",
			pos:  position{line: 17, col: 1, offset: 291},
			expr: &actionExpr{
				pos: position{line: 17, col: 11, offset: 301},
		...
		},
		{
			...
			expr: &actionExpr{
				pos: position{line: 21, col: 9, offset: 350},
				run: (*parser).callonUnit1,
				expr: &choiceExpr{
					pos: position{line: 21, col: 10, offset: 351},
					alternatives: []any{
						&litMatcher{
							pos:        position{line: 21, col: 10, offset: 351},
							val:        "ms",
						...
						&litMatcher{
							pos:        position{line: 21, col: 17, offset: 358},
							val:        "us",
							ignoreCase: false,
							want:       "\"us\"",
						},
						&litMatcher{
							pos:        position{line: 21, col: 24, offset: 365},
							val:        "µs",
							ignoreCase: false,
							want:       "\"µs\"",
						},
						&litMatcher{
							pos:        position{line: 21, col: 31, offset: 373},
							val:        "ns",
							ignoreCase: false,
							want:       "\"ns\"",
						},
						&charClassMatcher{
							pos:        position{line: 21, col: 38, offset: 380},
							val:        "[a-z]",
							ranges:     []rune{'a', 'z'},
							ignoreCase: false,
							inverted:   false,
		...
		{
			name: "EOF",
			pos:  position{line: 25, col: 1, offset: 420},
			expr: &notExpr{
				pos: position{line: 25, col: 8, offset: 427},
				expr: &anyMatcher{
					line: 25, col: 9, offset: 428,
				},
			},
		},
	},
...
func (c *current) onDuration1(sign, segments any) (any, error) {
	return Result{Sign: sign, Segments: segments.([]any)}, nil
}
